...
Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector),
  ...
  (function (a, b) {
    ...
    var g = function (c, e) {
      ...
      var f = this;
      return ((this.container = 'string' == typeof c ? document.querySelector(c) : c), !this.container)
        ...
        : ((this.config = d(
          ...
          this.pages.length
            ? void ((this.horizontal = 'horizontal' === this.config.orientation),
              ...
              this.init())
            : console.error('Pageable:', 'No child nodes matching the selector ' + this.config.childSelector + ' could be found.'));
    };
    return (
      ...
      (g.prototype.bind = function () {
        (this.callbacks = { wheel: this._wheel.bind(this), update: e(this.update.bind(this), this.config.throttle), load: this._load.bind(this), start: this._start.bind(this), drag: this._drag.bind(this), stop: this._stop.bind(this), click: this._click.bind(this), prev: this.prev.bind(this), next: this.next.bind(this), keydown: this._keydown.bind(this) }),
      ...
      (g.prototype.update = function () {
        clearTimeout(this.timer), (this.data = { window: { width: window.innerWidth, height: window.innerHeight }, container: { height: this.wrapper.scrollHeight, width: this.wrapper.scrollWidth } });
      ...
      (g.prototype.destroy = function () {
        if (this.initialised) {
          ...
          for (var a, b = 0; b < this.pages.length; b++) (a = this.pages[b]), (a.style.height = ''), (a.style.width = ''), (a.style.float = ''), a.classList.remove('pg-page'), a.classList.remove('pg-active');
      ...
      (g.prototype.emit = function (a) {
        if (((this.listeners = this.listeners || {}), !1 != a in this.listeners)) for (var b = 0; b < this.listeners[a].length; b++) this.listeners[a][b].apply(this, [].slice.call(arguments, 1));
      }),
